  ...
  $.fn.extend({
    hexanize: function(options) {
      ...
      return this.each(function() {
        ...
        return _this.addClass('hexanize').append($('<div/>').addClass('hexanize-inner1')).append($('<div/>').addClass('hexanize-inner2')).css({
          'background-image': 'url(' + settings.background + ')'
        }).on('click', function() {
          return window.location = _this.data('background');
        });
      });
    }
  });
